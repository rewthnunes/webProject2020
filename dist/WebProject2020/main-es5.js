...
module.exports = "<div class=\"container\">    \n    <div class=\"container-fluid\">     \n        <div style=\"text-align: right\"> <h2>Cidades da região metropolitana de campinas</h2> </div>             \n        <div class=\"panel-group\" id=\"accordion\">  \n            <div class=\"panel panel-default\" >\n                <div class=\"panel-heading\">\n                    <h4 class=\"panel-title titCollapse\">\n                        <a data-toggle=\"collapse\" data-parent=\"#accordion\" (click)=\"openCloseCollapse('collapse1')\">\n                            Sobre RMC\n                        </a>\n                    </h4>\n                </div>\n                <div id=\"collapse1\" class=\"panel-collapse collapse in\" *ngIf=\"flag.coll1\">\n                    <div class=\"panel-body\">\n                        <div class=\"row\"><br>\n                            <div class=\"col-sm-12 float-center\"><h4>Campinas e sua região</h4><hr></div>\n                            <div class=\"col-sm\"><br>                \n                                <p>\n                                    A Região Metropolitana de Campinas foi criada em 2000 e é integrada por 20 municípios: Americana, Artur Nogueira, Campinas, Cosmópolis, Engenheiro Coelho, Holambra, Hortolândia, Indaiatuba, Itatiba, Jaguariúna, Monte Mor, Morungaba, Nova Odessa, Paulínia, Pedreira, Santa Bárbara d'Oeste, Santo Antônio de Posse, Sumaré, Valinhos e Vinhedo. É a segunda maior região metropolitana do Estado de São Paulo em população, com mais de 3,2 milhões de habitantes, de acordo com estimativa do Instituto Brasileiro de Geografia e Estatística (IBGE) para 2018, e gerou 8,75% do Produto Interno Bruto (PIB) estadual em 2016.                \n                                </p>\n                            </div>\n                            <div class=\"col-sm\"><br>\n                                <p>\n                                    Nos últimos anos, a região vem ocupando e consolidando importante posição econômica nos níveis estadual e nacional. Contígua à Região Metropolitana de São Paulo, a RMC comporta um parque industrial moderno, diversificado e composto por segmentos setoriais complementares. Possui uma estrutura agrícola e agroindustrial bastante significativa e desempenha atividades terciárias de expressiva especialização. Destaca-se, ainda, pela presença de centros inovadores no campo das pesquisas científica e tecnológica, bem como do Aeroporto de Viracopos, localizado no município de Campinas, o segundo maior do país em transporte de carga. Em 2015, foi a maior porta de entrada de mercadorias importadas.\n                                </p>          \n                            </div>\n                            <div class=\"col-sm\"><br>\n                                <div class=\"col-sm-12\"><br>\n                                    <img class=\"img-Adjust\" alt=\"Região Campinas mapa\" src=\"./../assets/images/mapa_RMC_large.jpg\">\n                                </div>                   \n                            </div>\n                        </div>                \n                    </div>           \n                </div>\n            </div>\n    \n            <div class=\"panel panel-default\">\n                <div class=\"panel-heading\">\n                    <h4 class=\"panel-title titCollapse\">\n                        <a data-toggle=\"collapse\" data-parent=\"#accordion\" (click)=\"openCloseCollapse('collapse2')\">\n                            Indicadores RMC\n                        </a>\n                    </h4>\n                </div>\n                <div id=\"collapse1\" class=\"panel-collapse collapse in\" *ngIf=\"flag.coll2\">\n                    <div class=\"panel-body\">\n                        <div class=\"row\"><br>\n                            <div class=\"col-sm-12 float-center\"><h4>Dados da região</h4><hr></div>\n                            <div class=\"col-sm table-action\"><br>                \n                                <table class=\"table table-striped\">\n                                    <thead class=\"thead-dark\">\n                                        <tr>\n                                        <th>Municípios</th>\n                                        <th>Área (km²)¹</th>\n                                        <th>População 2018¹</th>\n                                        <th>Densidade Demográfica 2018 (hab/km²)¹</th>\n                                        <th>TGCA 2010/2018 (%)²</th>\n                                        <th>PIB 2016 (mil reais)¹</th>\n                                        <th>Distância até São Paulo (km)³</th>\n                                        <th style=\"width: 50px; text-align: center\">Ir ao mapa</th>\n                                        </tr>\n                                    </thead>\n                                    <tbody>\n                                        <tr *ngFor=\"let item of detalhes; let i = index\">\n                                        <th>{{item.cidade}}</th>\n                                        <td>{{item.area}}</td>\n                                        <td>{{item.populacao}}</td>\n                                        <td>{{item.densidade}}</td>\n                                        <td>{{item.tgca}}</td>\n                                        <td>{{item.pib}}</td>\n                                        <td style=\"text-align: center\">{{item.distancia}} Km</td>     \n                                        <td class=\"links-tabela\" (click)=\"irAoMApa(item, i)\">\n                                            <a>\n                                                <svg width=\"1em\" height=\"1em\" viewBox=\"0 0 16 16\" class=\"bi bi-reply-fill\" fill=\"currentColor\" xmlns=\"http://www.w3.org/2000/svg\">\n                                                    <path d=\"M9.079 11.9l4.568-3.281a.719.719 0 0 0 0-1.238L9.079 4.1A.716.716 0 0 0 8 4.719V6c-1.5 0-6 0-7 8 2.5-4.5 7-4 7-4v1.281c0 .56.606.898 1.079.62z\"/>\n                                                </svg>\n                                            </a>\n                                        </td>               \n                                        </tr>\n                                    </tbody>\n                                </table>  \n                                <div class=\"col-sm-12 infoDados\"><br>\n                                    <span>¹Fonte: IBGE</span> &nbsp; | &nbsp;\n                                    <span>²Fonte: Emplasa</span> &nbsp; | &nbsp;\n                                    <span>³Fonte: DER - Departamento de Estradas de Rodagem</span> &nbsp; | &nbsp;\n                                    <span>Elaboração: Emplasa, GIP/CDI, 2019.</span>        \n                                </div><br>    \n                            </div>\n                        </div>                \n                    </div>           \n                </div>\n            </div>         \n        </div>    \n    </div>  \n</div>\n\n<link rel=\"stylesheet\" href=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css\">\n<script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js\"></script>\n<script src=\"https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js\"></script>"
...
var CollapseIdModel = /** @class */ (function () {
    function CollapseIdModel() {
        this.coll1 = false;
        this.coll2 = false;
        this.coll3 = false;
        this.coll4 = false;
...
/* harmony import */ var primeng_inputtextarea__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! primeng/inputtextarea */ "./node_modules/primeng/fesm5/primeng-inputtextarea.js");
...
var ContatoComponent = /** @class */ (function () {
    ...
    ContatoComponent.prototype.limpaForm = function () {
        this.object = new _models_form_model__WEBPACK_IMPORTED_MODULE_2__["Formulario"]();
    };
    ContatoComponent.prototype.enviar = function () {
        if (this.validaForm()) {
            this.limpaForm();
    ...
    ContatoComponent.prototype.fechaAviso = function () {
        setTimeout(function () { }, 2000);
        this.flagAlert = false;
    };
    ContatoComponent.prototype.validaForm = function () {
        if (!this.object.nome) {
            this.flagAlert = true;
...
module.exports = ".float-left {\n    color: #00b5b0;\n}\n\n.float-center {\n  color: #00b5b0;\n  text-align: center;\n}\n\nth {\n  width: 100px\n}\n\n.links-tabela{\n  color: #00b5b0;\n  text-decoration: underline;\n  cursor: pointer;\n  text-align: center\n}\n\n.infoDados {\n  font-size: 11px;\n  font-weight: bold;\n}\n\n.titCollapse {\n  cursor:pointer; \n  color: #00b5b0\n}\n\n.img-Adjust {\n  max-width:240px; \n  margin-top: 20px\n}\n\n@media (max-width: 480px) {\n\n  .table-action thead {\n    display: none;\n  }\n\n  .table-action tr {\n    border-bottom: 1px solid black;\n  }\n  .table-action td {\n    border: 0;\n  }\n\n  .table-action td:not(:first-child) {\n    display: block;\n  }\n\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _assets_files_detalheCidades_json__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./../../assets/files/detalheCidades.json */ "./src/assets/files/detalheCidades.json");
var _assets_files_detalheCidades_json__WEBPACK_IMPORTED_MODULE_2___namespace = /*#__PURE__*/__webpack_require__.t(/*! ./../../assets/files/detalheCidades.json */ "./src/assets/files/detalheCidades.json", 1);
/* harmony import */ var _models_collapse_id_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./../_models/collapse-id.model */ "./src/app/_models/collapse-id.model.ts");
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent() {
        this.detalhes = _assets_files_detalheCidades_json__WEBPACK_IMPORTED_MODULE_2__.detalhes;
        this.flag = new _models_collapse_id_model__WEBPACK_IMPORTED_MODULE_3__["CollapseIdModel"]();
    }
    HomeComponent.prototype.ngOnInit = function () {
    };
    HomeComponent.prototype.irAoMApa = function (parm, i) {
        alert("Abrir mapa de -> !" + parm.cidade + ' | ' + "Array nº: " + i);
    };
    HomeComponent.prototype.openCloseCollapse = function (key) {
        switch (key) {
            case "collapse1":
...
// IMPORTACAO DOS ARQUIVOS .JSON QUE SERAO UTILIZADOS PARA CARREGAMENTO DO MAPA
...
var MapComponent = /** @class */ (function () {
    ...
    MapComponent.prototype.initSouthAmerica = function () {
    ...
    MapComponent.prototype.initCampinas = function () {
    ...
    MapComponent.prototype.desenhaCampinas = function () {
        var myStyle = {
            "color": "#ff7800",
            "weight": 1,
            "opacity": 0.15
    ...
    MapComponent.prototype.adicionaMarcador = function () {
        // ITERAÇÃO PARA MARCAR TODAS A CIDADES DA GERIAO DE CAMPINAS A PARTIR 
        // DAS COORDENADAS OBTIDAS PELO ARQUIVO .JSON
    ...
    // IMAGEM CONVERTIDA EM BASE64 DEVIDO A CONFLITOS OCORRIDOS, SERÁ REMOVIDA 
    MapComponent.prototype.adicionaProduto = function () {
        var scooter = leaflet__WEBPACK_IMPORTED_MODULE_2__["icon"]({
        ...
        var p1 = leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"]([-22.8730, -47.0580], { icon: scooter }).addTo(this.map);
        var p2 = leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"]([-22.8741, -47.0431], { icon: scooter }).addTo(this.map);
        var p3 = leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"]([-22.8709, -47.0479], { icon: scooter }).addTo(this.map);
        var p4 = leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"]([-22.8705, -47.0479], { icon: scooter }).addTo(this.map);
    };
...
var PrincipalComponent = /** @class */ (function () {
    function PrincipalComponent() {
        this.arrayCidades = _assets_files_dataObject_json__WEBPACK_IMPORTED_MODULE_2__;
    }
...
var SobreComponent = /** @class */ (function () {
    ...
    SobreComponent.prototype.openCloseCollapse = function (key) {
        switch (key) {
            case "collapse1":
                this.flag.coll1 = !this.flag.coll1;
                break;
...
/***/ "./src/assets/files/detalheCidades.json":
/*!**********************************************!*\
  !*** ./src/assets/files/detalheCidades.json ***!
  \**********************************************/
/*! exports provided: detalhes, default */
/***/ (function(module) {

module.exports = {"detalhes":[{"area":"794,57","populacao":"1.194.094","densidade":"1.502,82","tgca":"1,26","pib":"58.523.732","distancia":93,"cidade":"Campinas"},{"area":"153,47","populacao":278.571,"densidade":"1.815,21","tgca":"1,81","pib":"12.061.112","distancia":118,"cidade":"Sumaré"},{"area":"62,42","populacao":227.353,"densidade":"3.642,54","tgca":"2,09","pib":"11.515.071","distancia":109,"cidade":"Hortolândia"},{"area":"133,91","populacao":237.112,"densidade":"1.770,66","tgca":"1,49","pib":"10.287.915","distancia":127,"cidade":"Americana"},{"area":"81,60","populacao":77.308,"densidade":"947,36","tgca":"2,47","pib":"7.830.623","distancia":79,"cidade":"Vinhedo"},{"area":"148,54","populacao":127.123,"densidade":"855,83","tgca":"2,20","pib":"5.095.635","distancia":85,"cidade":"Valinhos"},{"area":"138,78","populacao":106.776,"densidade":"769,41","tgca":"3,33","pib":"31.504.043","distancia":117,"cidade":"Paulinia"},{"area":"65,58","populacao":14.579,"densidade":"222,32","tgca":"3,24","pib":"909.273","distancia":133,"cidade":"Holambra"},{"area":"141,39","populacao":56.221,"densidade":"397,63","tgca":"3,02","pib":"8.422.260","distancia":123,"cidade":"Jaguariúna"},{"area":"271,03","populacao":192.536,"densidade":"710,39","tgca":"0,84","pib":"5.079.379","distancia":135,"cidade":"Sta Barbara d'Oeste"},{"area":"108,82","populacao":47.361,"densidade":"435,24","tgca":"1,65","pib":"1.124.077","distancia":137,"cidade":"Pedreira"},{"area":"154,13","populacao":23.085,"densidade":"149,77","tgca":"1,40","pib":"887,953","distancia":138,"cidade":"Sto Antônio de Posse"},{"area":"311,55","populacao":246.908,"densidade":"792,53","tgca":"2,57","pib":"11.735.699","distancia":98,"cidade":"Indaiatuba"},{"area":"240,57","populacao":58.765,"densidade":"244,28","tgca":"2,31","pib":"2.260.957","distancia":117,"cidade":"Monte Mor"},{"area":"178,03","populacao":53.45,"densidade":"300,24","tgca":"2,41","pib":"991.268","distancia":145,"cidade":"Artur Nogueira"},{"area":"73,79","populacao":59.371,"densidade":"804,62","tgca":"1,86","pib":"2.810.058","distancia":122,"cidade":"Nova Odessa"},{"area":"154,67","populacao":70.998,"densidade":"459,04","tgca":"2,38","pib":"1.318.217","distancia":135,"cidade":"Cosmópolis"},{"area":"322,28","populacao":119.09,"densidade":"369,53","tgca":"2,02","pib":"5.122.838","distancia":84,"cidade":"Itatiba"},{"area":"146,75","populacao":13.458,"densidade":"91,71","tgca":"1,69","pib":"396.689","distancia":107,"cidade":"Morungaba"},{"area":"109,94","populacao":20.284,"densidade":"184,50","tgca":"3,24","pib":"439.779","distancia":158,"cidade":"Engenheiro Coelho"}]};
